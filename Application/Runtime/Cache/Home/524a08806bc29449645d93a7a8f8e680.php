...
<body>
    ...
    <section id="main" class="page-login">
        <div class="container_12">
			...
			<form class="registed" action="/index.php/Home/Login/register" method="post">
			    <h2>注册客户</h2>
			    <p>按步骤依次填写:</p>
                <div class="email">
                ...
                <div class="verify">
				<strong>验证码：*</strong><sup>*</sup><br>
                <img src="/index.php/Home/Login/yzm" alt="">
