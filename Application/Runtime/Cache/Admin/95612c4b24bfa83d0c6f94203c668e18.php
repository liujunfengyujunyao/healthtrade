...
<title>添加分类 - 分类管理 - Healthtrade后台</title>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<form class="form form-horizontal" id="form-article-add" action="/index.php/Admin/Category/add" method="post" enctype="multipart/form-data">
		<div class="row cl" align="center" >
		<a href="/index.php/Admin/Category/index" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe67f;</i>&emsp;返回列表页&emsp;</a>
				&emsp;&emsp;<span class="btn btn-default radius"><sup></sup>这个是分类 ?</span>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>分类名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value=""  required="required" placeholder="请填写分类名" id="" name="cate_name">
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button class="btn btn-primary radius" type="submit" id="addgood"><i class="Hui-iconfont">&#xe632;</i> 保存</button>
