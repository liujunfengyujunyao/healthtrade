	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加商品" _href="add.html" href="/index.php/Admin/Goods/add"><i class="Hui-iconfont">&#xe600;</i> 添加商品</a>
				</span>
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
							...
							<td><?php echo ($v["id"]); ?></td>
							<td class="text-l"><a href="/index.php/Admin/Goods/detail/id/<?php echo ($v["id"]); ?>"><?php echo ($v["goods_name"]); ?></a></td>
							<td class="text-l" ><center><?php echo ($v["cate_name"]); ?></center></td>
							<td><font color="blue"><?php echo ($v["goods_ori_price"]); ?></font></td>
							<td><font color="red"><b><?php echo ($v["goods_price"]); ?></b></font></td>
							<td><?php echo ($v["goods_number"]); ?></td>
							<td><img src="<?php echo ($v["goods_small_img"]); ?>" alt=""></td>
							<td class="td-status"><span class="label label-success radius"><?php echo (date("Y-m-d",$v["goods_create_time"])); ?></span></td>
							<td class="f-14 td-manage">
								<a style="text-decoration:none" class="ml-5" href="/index.php/Admin/Goods/edit/id/<?php echo ($v["id"]); ?>" title="商品编辑"><i class="Hui-iconfont">&#xe6df;编辑</i></a>
								<a style="text-decoration:none" class="ml-5" onClick="goods_del(this,'<?php echo ($v["id"]); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;删除</i></a>
								</td>
...
function goods_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: '/index.php/Admin/Goods/del/id/'+id,
			dataType: 'json',
