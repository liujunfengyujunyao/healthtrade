...
<title>评论列表 - 评论管理 - Healthtrade后台</title>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;"  class="btn btn-danger radius" id="delAll"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> </span> <span class="r"></div>
			<div class="mt-20">
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr class="text-c">
							<td><input type="checkbox" value="<?php echo ($val["id"]); ?>" name="del_one"></td>
							<td><?php echo ($val["id"]); ?></td>
							<td><a href="javascript:;" onclick="member_show('<?php echo ($val["username"]); ?>','/index.php/Admin/Review/member/id/<?php echo ($val["user_id"]); ?>','','600','500')"><?php echo ($val["username"]); ?><i class="avatar size-L radius"><img alt="" src="http://static.h-ui.net/h-ui/images/avatar-default-S.gif"></i></a></td>
							<td class="text-l"><div class="c-999 f-12">
									<u style="cursor:pointer" class="text-primary" onclick="member_show('<?php echo ($val["username"]); ?>','/index.php/Admin/Review/member','<?php echo ($val["user_id"]); ?>','600','500')"><?php echo ($val["username"]); ?></u> <time title="2014年8月31日 下午3:20" datetime="<?php echo ($val["create_time"]); ?>"><?php echo ($val["create_time"]); ?></time> <span class="ml-20"><?php echo ($val["phone"]); ?></span> <span class="ml-20"><?php echo ($val["email"]); ?></span></div>
									<div class="f-12 c-999"><a href="/index.php/Home/Index/detail/id/<?php echo ($val["goods_id"]); ?>" target="_blank">/index.php/Home/Index/detail/id/<?php echo ($val["goods_id"]); ?></a></div>
								<div><?php echo ($val["review_content"]); ?></div></td>
							<td class="td-manage"> <a title="删除" href="javascript:;" onclick="if(confirm('确认删除？')) location.href='/index.php/Admin/Review/del/id/<?php echo ($val["id"]); ?>'" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
	...
	$('#delAll').click(function(){
		...
		layer.confirm('确认删除？',function(){
			$.ajax({
				...
				'dataType':'json',
				'data':'ids='+ids,
				'url':'/index.php/Admin/Review/delAll',
				'success':function(response){
					if(response.code!=10000){
						...
						location.href="/index.php/Admin/Review/index";
					}
				}
			});
		});
		// layer.confirm('确认删除？',function(){
		// 	location.href = "/index.php/Admin/Review/del_all/ids/" + ids;
		// });
	});
});
/*用户-添加*/
